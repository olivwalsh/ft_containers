...
/*   Updated: 2023/02/21 19:02:43 by owalsh           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_set()
{
	...
	ft::pair<ft::set<int>::iterator, ft::set<int>::iterator> p = test.equal_range(9);
	ft::set<int>::iterator lowerbound = p.first;
	ft::set<int>::iterator upperbound = p.second;

	
	
	std::cout << "p.first = " << *lowerbound << std::endl;
	std::cout << "p.second = " << *upperbound << std::endl;
