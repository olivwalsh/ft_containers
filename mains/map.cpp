...
void test_map()
{
	...
	maptest.insert(ft::make_pair(1, "one"));
	maptest.insert(ft::make_pair(2, "two"));
	maptest.insert(ft::make_pair(3, "three"));
	maptest.insert(ft::make_pair(4, "one"));

	print(maptest);
	// maptest.print();

	ft::map<int, std::string>::iterator found = maptest.find(50);
	...
	ft::map<int, std::string>::iterator end = maptest.end();
	end++;
	end++;
	ft::map<int, std::string>::iterator begin = maptest.begin();
	begin--;
	begin--;
	maptest.erase(maptest.begin(), begin);
